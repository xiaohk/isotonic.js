...
unitTestAssert(
  ...
  () => {
    ...
    model.fit(x, y, w);
    console.log([model.xThresholds, model.yThresholds]);
...
model.fit([1, 2, 3, 4], [0, 5, 11, 10], [1, 1, 1, 1]);

console.log(model.yThresholds);
console.log(model.xThresholds);

// model.fit([1, 2], [0, 5, 11], [1, 1, 1]);
